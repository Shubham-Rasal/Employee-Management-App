...
def backup():
    ...
    OBJECT_TO_BACKUP = '/mnt/d/coding/web dev/test-servers/Employee-Management-App/src/mysql_data'  # The file or directory to backup
    BACKUP_DIRECTORY = '/mnt/d/coding/web dev/test-servers/Employee-Management-App/backup'  # The location to store the backups in
